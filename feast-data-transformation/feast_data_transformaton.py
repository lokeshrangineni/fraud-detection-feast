...
def main():
    print("in main, data transformation going to begin and it may take a while")
    train = pd.read_csv(
        "train.csv"
    )
    test = pd.read_csv(
    ...
    print("reading of the files is done")
